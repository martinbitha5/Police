...
import { SITE_APPS, WEB_PAGES } from '@/lib/site-apps';
...
const COLUMNS: { title: string; links: FooterLink[] }[] = [
  ...
  {
    // Les pages légales et l'état des services vivent sur le portail principal.
    title: 'Informations',
    links: [
      { label: 'État des systèmes', href: WEB_PAGES.status, external: true },
      { label: 'FAQ', href: WEB_PAGES.faq, external: true },
      { label: 'Mentions légales', href: WEB_PAGES.legal, external: true },
      { label: 'Conditions d’utilisation', href: WEB_PAGES.conditions, external: true },
    ],
  },
  {
    title: 'Partenaires',
      ...
      <div className="sf-inner">
        ...
        <div className="sf-bottom">
          <div className="sf-brand">
            ...
            <span className="sf-brand-name">Police Bagage Trust Center</span>
          </div>

          <div className="sf-partners">
            <span className="sf-partner-label">Édité par</span>
            <a href="https://www.ats-handling-rdc.com/" target="_blank" rel="noopener noreferrer" className="sf-partner-pill ft-link">
        ...
        <div className="sf-legal">
          ...
          <div className="sf-legal-text">
            ...
            <span className="sf-copy">Trust Center de la plateforme Police Bagage</span>
          </div>
        </div>
      </div>
    </footer>
