      ...
      <ScrollView style={styles.container} contentContainerStyle={[styles.content, pad]}>
        ...
        <GlassCard strong contentStyle={styles.header}>
          ...
          <View style={[styles.modePill, { borderColor: colors.primary }]}>
            <Text style={[styles.modeText, { color: colors.primary }]}>DOLLY</Text>
          </View>
        </GlassCard>

        {/* Bandeau progression : onDolly / bagages enregistrés du vol */}
        {accepted ? (
          <GlassCard contentStyle={styles.progressCard}>
            ...
            <Text style={styles.progressText}>
              <Text style={[styles.progressNum, complete && { color: colors.success }]}>{accepted.onDolly}</Text>
              <Text style={styles.progressSep}> / {accepted.confirmed} </Text>
              bagages enregistrés sur le dolly
            </Text>
          </GlassCard>
        ) : null}
